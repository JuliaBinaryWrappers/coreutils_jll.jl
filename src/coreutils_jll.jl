...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import coreutils_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5818bda4-868b-5068-b238-e370ed6eefef"))
platforms = [Pkg.Artifacts.unpack_platform(e, "coreutils", artifacts_toml) for e in artifacts["coreutils"]]
...
if best_platform === nothing
    @debug("Unable to load coreutils; unsupported platform $(triplet(platform_key_abi()))")
else
